...
public class Notes {
    ...
    @PostMapping("/notes")
    public String addNewNote(@ModelAttribute("newNote") Note note, Authentication authentication, Model model){
        if(note != null){
            ...
            if(user != null && user.getUserid() != null)
            {
                ...
                if(note.getNoteId() != null){
                    ...
                    if (createdNoteId != null) {
                        ...
                        // Error occured while trying to add the note to the DB, redirect to home page with failure message
                        return "redirect:/";
                    }
                }
            }
    ...
    public String deleteNote(@RequestParam(name = "noteId", required = true) String noteId){
        if(noteId != null){
